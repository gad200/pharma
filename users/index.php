            ...
            <div class="list-group list-group-flush mx-3 mt-4">
              <a style="color: #3FA99E;font-weight:bold; " href="../index.php" class="list-group-item list-group-item-action py-2 ripple  " aria-current="true">
                ...
                <a style="color: #3FA99E;font-weight:bold; " href="../charts/index.php" class="list-group-item list-group-item-action py-2 ripple ">
                    <i class="fas fa-shopping-bag fa-fw me-3" style="color: #3FA99E;"></i><span> المنتجات</span></a>                <a style="color: #3FA99E;font-weight:bold; " href="../dwa/index.php" class="list-group-item list-group-item-action py-2 ripple ">
...
<!--              </a>-->
              ...
              <a style="color: #3FA99E;font-weight:bold; " href="index.php" class="list-group-item list-group-item-action py-2 ripple "><i class="fas fa-user " style="color: #3FA99E;"></i><span> العملاء</span></a>
